...
## This function takes a dataset and a specified variable to generate a summary of demographic characteristics based on that variable.
data_var <- function(data, VAR){
...
data_var(adsl_saf, SEX)
data_var(adsl_saf, AGEGR1)
data_var(adsl_saf, RACE)
